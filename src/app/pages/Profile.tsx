...
const menuSections = [
  ...
  },
  {
    title: 'Data',
    items: [
      { icon: Download, label: 'Offline Maps' },
      { icon: Trash2, label: 'Clear Cache' },
      { icon: FileDown, label: 'Export My Data' },
    ],
  },
  {
    title: 'Support',
  ...
  return (
    <div className="h-full flex flex-col bg-[#0A1F0A] overflow-auto">
      ...
      <div className="px-5 pt-6 pb-3">
        <h1 className="text-2xl font-bold text-[#E8F5E9]">Profile</h1>
      </div>
      ...
      <div className="px-5 pb-6 space-y-5">
        ...
        <div className="bg-[#132A1A] rounded-xl p-6 border border-[#1B4D2E] flex flex-col items-center">
          ...
          <div className="flex items-center gap-6">
            <div className="text-center">
              ...
              <p className="text-[10px] text-[#6B8E6B]">Fields</p>
            </div>
            <div className="w-px h-8 bg-[#1B4D2E]" />
            <div className="text-center">
              <p className="text-xl font-bold text-[#52B788]">0</p>
              <p className="text-[10px] text-[#6B8E6B]">Analyses</p>
            </div>
            <div className="w-px h-8 bg-[#1B4D2E]" />
            <div className="text-center">
              <p className="text-xl font-bold text-[#52B788]">0</p>
        ...
        {/* Language highlight */}
        <button className="w-full flex items-center justify-between bg-[#52B788]/10 border border-[#52B788]/30 rounded-xl px-4 py-3.5 hover:bg-[#52B788]/15 transition-colors">
          <div className="flex items-center gap-3">
            <Globe size={20} className="text-[#52B788]" />
            <div className="text-left">
              <p className="text-sm font-semibold text-[#E8F5E9]">Choose Language</p>
              <p className="text-[10px] text-[#6B8E6B]">English · తెలుగు · हिंदी · தமிழ் · ಕನ್ನಡ</p>
            </div>
          </div>
              ...
              {section.items.map((item, i) => (
                ...
                >
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm text-[#E8F5E9]">{item.label}</span>
                  </div>
                  {'value' in item && item.value ? (
                    <span className="text-xs text-[#6B8E6B]">{item.value}</span>
                  ) : (
